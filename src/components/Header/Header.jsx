    ...
    <div className="header  ">
      <div className="top-header container ">
        <div className="left-top-header">
          <h1>МОБИЛОГРАФИЯ</h1>
          <p>
            Заманбап видео тартуу жана монтаждоо практикалык программасы 100%
            жыйынтык менен чыгуучу жалгыз курс Себеби, биз кунумдук "фишкаларды"
            айтуудан тышкары, кадам сайын нөлдөн тарта профессионалдуу
            жыйынтыкка жеткиребиз.
          </p>
      ...
      <div className="header-block container ">
        <div>
          ...
          <img src={hobby} alt="" />{" "}
          <p>
            Өзү үчүн кызыгып, тартып, жаны хобби менен алек болгусу келгендерге
          </p>
        </div>
        <div>
          {" "}
          <img src={work} alt="" />{" "}
          <p>
            Мобилография кесибин аркалап, андан жакшы киреше табууну
            көздөгөндөргө
          </p>
        </div>
        <div>
          ...
          <p>
            Өз бизнеси же компаниясы үчүн мыкты видео-контент жаратууну
            ойлогондорго
          </p>{" "}
        </div>
      </div>
